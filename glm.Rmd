...
R2 = indicado da nuvem de pontos para fins preditivos.  percentual de comportamento da variável dependente devido ao comportamento das preditoras, ou seja, o que não conseguimos capturar de variãncia é devido a omissão de variáveis que poderiam contribuir parao modelo
...
Aumentando o intervalo de confiançã podemo comprometer a significância estatística do parametro.
